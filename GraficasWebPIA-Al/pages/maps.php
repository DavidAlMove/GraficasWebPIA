...
<body>
			...
			<div class="containerS">
					...
					<img src="<?php echo $link; ?>media/images/GAME UI-05.png" alt="Italian Trulli">

				<a href="<?php echo $link; ?>pages/game.php"><img src="<?php  echo $link; ?>media/images/GAME UI-51.png" alt="Italian Trulli" id="btnAtras"></a>


				<img src="<?php echo $link; ?>media/images/mapaM.jpg" alt="Italian Trulli" id="map">
				


				<a href="<?php echo $link; ?>pages/personaje.php"><img src="<?php  echo $link; ?>media/images/GAME UI-53.png" alt="Italian Trulli" id="btnAceptar"></a>
